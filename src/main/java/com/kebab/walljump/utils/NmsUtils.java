package com.kebab.walljump.utils;

import com.kebab.walljump.utils.BukkitUtils.Version;
...
public class NmsUtils {
    ...
    private static Sound getSoundForBlock(Block block, String fieldName) {
        try {
            ...
            // Resolve the namespaced Minecraft key through the Bukkit registry.
            NamespacedKey soundKey = NamespacedKey.fromString(key);
            Sound sound = soundKey == null ? null : Registry.SOUNDS.get(soundKey);
            return sound == null ? Sound.BLOCK_STONE_PLACE : sound;
